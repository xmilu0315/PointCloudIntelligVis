...
class PC_SEG(db.Model):
    __tablename__ = 'pc_seg'
    ...
    xyzlArray_href = db.Column(db.String(255), comment="xyzl.npy存储路径")
    vis_href = db.Column(db.String(255), comment="可视化HTML存储路径")
    num_part = db.Column(db.String(255), comment="模型预测的类别名称")
