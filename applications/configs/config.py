...
class BaseConfig:
    SYSTEM_NAME = os.getenv('SYSTEM_NAME', '后台管理')
    # 主题面板的链接列表配置
    SYSTEM_PANEL_LINKS = [
        {
            "icon": "layui-icon layui-icon-auz",
            "title": "官方网站",
            "href": "https://www.xju.edu.cn"
        },
        {
            "icon": "layui-icon layui-icon-auz",
            "title": "开发文档",
    ...
    # 点云分类
    UPLOADED_CLS_PC_SOURCE_DEST = 'static/cls_pc_source'  # ply源文件的保存路径
    UPLOADED_CLS_PC_VIS_DEST = 'static/cls_pc_vis'  # k3d生成的html文件保存路径

    # 点云分割
    UPLOADED_SEG_PC_SOURCE_DEST = 'static/seg_pc_source'  # ply源文件的保存路径
    UPLOADED_SEG_PC_XYZLARRAY_DEST = 'static/seg_pc_xyzlArray'  # 处理后的npy文件保存路径
    UPLOADED_SEG_PC_VIS_DEST = 'static/seg_pc_vis'  # k3d生成的html文件保存路径

    # 模型2的分类权重路径
    UPLOADED_NET2_CLS_PTH_DEST = 'applications/view/pc/network2/cls/pth'

    # 模型2的分割权重路径
    UPLOADED_NET2_SEG_PTH_DEST = 'applications/view/pc/network2/seg/pth'
